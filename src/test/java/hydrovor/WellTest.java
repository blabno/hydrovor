...
public class WellTest {
    ...
    @Test
    public void getWater_negativeDesiredVolume_expectedException()
    {
    ...
    @Test
    public void getWater_desiredVolumeLessThanVolume_desiredVolume()
    {
...
@Test
    public void getWater_getWater_desiredVolumeGreaterThanVolume_volumeEqualzero()
{
    Well well=new Well(1);
    well.getWater(2);
    int result= well.getWater(2);
